...
const Cart = () => {
  let el = {
    ...
    subcategory: "dress",
    image:
      "https://m.media-amazon.com/images/G/01/Shopbop/p/prod/products/berna/berna30007192f2/berna30007192f2_1650048139171_2-0._QL90_UX564_.jpg",
    brand: "Bernadette",
    title: "Birgit Floral Dress",
    price: 66568,
    desc: "Fabric: Heavyweight, non-stretch textured weave - Tiered seams with raw edges",
  };
    ...
    <div className={styles.container}>
      ...
      <div>
        <div className={styles.checkout}>
          ...
          <button className={styles.checkout_btn} onClick={() => navigate("/payment")}>Checkout</button>
